...
if st.session_state['login_status']:
    ...
    with tab1:
        with st.form(key='rating_form'):
            ...
            rating_p = st_star_rating("Voto alla persona", maxValue=5, defaultValue=3, key="rating_p")
            rating_i = st_star_rating("Voto all'interazione", maxValue=5, defaultValue=3, key="rating_i")
            rating_v = st_star_rating("Voto alle vibes", maxValue=5, defaultValue=3, key="rating_v")
